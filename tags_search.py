...
# def get_user_contests(handle, contest_num):
#     # Fetch all contests
...
#     return len(finished_user_contests)

# Example usage
# user_handle = "Sushant81"
# number_of_contests = 10
# contests = get_user_contests(user_handle, number_of_contests)
